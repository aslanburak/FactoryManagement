        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Buildings_Factories_FactoryID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MaterialWarehouses", x => x.MaterialWarehouseID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MaterialTransactions", x => x.MaterialTransactionID);
                    table.ForeignKey(
                        name: "FK_MaterialTransactions_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MaterialTransactions_MaterialWarehouses_MaterialWarehouseID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Buildings_FactoryID",
                table: "Buildings",
                column: "FactoryID");

            migrationBuilder.CreateIndex(
                name: "IX_MaterialTransactions_AppUserId",
                table: "MaterialTransactions",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_MaterialTransactions_MaterialWarehouseID",
                table: "MaterialTransactions",
